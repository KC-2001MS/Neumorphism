...
Thank you for your interest in contributing to Neumorphism. Neumorphism is a framework that brings the soft-UI ("neumorphic") design language to native SwiftUI controls.

## How to Contribute

Contributions to Neumorphism are warmly welcomed and appreciated. Here are the areas where you can help:
...
1. Fork the Neumorphism repository and clone it to your local machine.
...
Neumorphism adheres to the [Contributor Covenant Code of Conduct](CODE_OF_CONDUCT.md) to create an inclusive and respectful environment for all users. Harassment of any kind is strictly prohibited. Kindly review the Code of Conduct for further details.
...
Your interest, assistance, and feedback are invaluable in enhancing the Neumorphism library. Thank you for your continued support.
